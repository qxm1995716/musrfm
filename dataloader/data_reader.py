...
import S2R10_MCHR  # this is a C++ function that complied using boostpython, which is not very stable at present, and we are working to find it bug.
    ...
    def sampler(self):
        ...
        if self.is_dbm:
            ...
            for idx in range(len(self.file_path)):
                ...
                mchr_data_list, coords_list = S2R10_MCHR.S2R10_MCHR(rhos, coords, self.mb_res, self.radius, 1)
