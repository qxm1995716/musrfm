...
This step is finished by **rhos_d_preprocess** function in **basic_modules.py**, and its detailed explaination is located in the docs.md. Here, we provide a templete for process a L2A imagery and its corresponding DEM data. In our code, the nondata value is -111111, please keep mind on this, especially when creat raster for mask or dem, to avoid any unpredicted bugs.  
